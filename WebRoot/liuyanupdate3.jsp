...
function check()
{
	...
	return true;
    	...
    	<td>
    	<input type="text" name="biaoti" style="width: 300px; height: 20px;" id="biaotiid"  value="${bean.biaoti }" readonly="readonly"/>
    	</td>
    	</tr>
    	...
    	<td>
    	<input type="text" name="biaoti" style="width: 300px; height: 20px;" id="biaotiid"  value="${bean.shijian2 }" readonly="readonly"/>
    	</td>
    	</tr>
    	...
    	<td>
    	<textarea rows="7" cols="50"  name="neirong" readonly="readonly">${bean.dafu }</textarea>

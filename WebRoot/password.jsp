   ...
   return false;
	...
	<BODY onload="createCode();">
		...
		<DIV class="wrapper lazybox excel-recom">
			...
			<form action="indexmethod!password.action" method="post" onsubmit="return checkform()">
    	...
    	<tr>
    	<td align="center">
    	<span style="font-weight: bold;font-size: 20px;">新密码:</span>
    	</td>
    	<td>
    	...
    	<tr>
    	<td align="center">
    	<span style="font-weight: bold;font-size: 20px;">确认新密码:</span>
    	</td>
    	<td>

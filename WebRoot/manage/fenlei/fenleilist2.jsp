...
<body >
  ...
  <tr>
    ...
    <input class='btn btn-primary' type='button' value="添加二级分类"  onclick="javascript:window.location.href='${url2 }add10.action?fid=${fid }';"/>
&nbsp;&nbsp;&nbsp;&nbsp;
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=1>
	...
	<TD align="center" >
    <a href="${url2 }update30.action?id=${bean.id }">查看</a> &nbsp; &nbsp; &nbsp;
  	<a href="${url2 }update10.action?id=${bean.id }">修改</a> &nbsp; &nbsp; &nbsp;
  	<a href="${url2 }delete10.action?id=${bean.id }" onclick="return confirm('确定要删除吗?'); ">删除</a>

...
<body >
  ...
  <tr>
    ...
    <input class='btn btn-primary' type='button' value="添加新供应商"  onclick="javascript:window.location.href='${url2 }add.action';"/>
&nbsp;&nbsp;&nbsp;&nbsp;
供应商名称：<input name="gname" type="text"  value="${gname }">

...
<HTML xmlns="http://www.w3.org/1999/xhtml">
	...
	<BODY>
		...
		<DIV class="wrapper lazybox excel-recom">
			...
			<a href="${url2 }add.action"><span style="font-size: 15px;font-weight: bold;">添加新收货信息</span></a>
			
    	<table align="center" border="1"  width="100%">
    	<tr><th >收货人姓名</th><th >电话</th><th >详细地址</th><th >操作</th></tr>
    	<c:forEach items="${list}"  var="bean">
    	<tr><td align="center"><span>${bean.truename }</span></td><td align="center">${bean.phone }</td><td align="center">${bean.address }</td>
<td align="center">
